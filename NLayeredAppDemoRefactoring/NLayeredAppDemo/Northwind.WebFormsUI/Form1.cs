...
namespace Northwind.WebFormsUI
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            // ileride burada dependency injection container'lardan yararlanacağız
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //ProProductManager productManager = new ProductManager(new EfProductDal());
        ...
        private void LoadCategories()
        {
            ...
            // Seçilen CategoryName olmalı ama etkilenen CategoryId olmak olmalı .
        ...
        private void tbxProductName_TextChanged(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(tbxProductName.Text))
                ...
                LoadProducts();
            //textbox boş ise loadproduct metodu çalışıyor. boş değil ise dgwProduct.datasource çalışıyor.
        }
